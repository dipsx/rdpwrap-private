...
The official Windows build also embeds the x86/x64 OffsetFinder and Zydis
artifacts produced by the pinned `llccd/RDPWrapOffsetFinder` submodule. The
installer uses those embedded tools for automatic offset generation and does
not execute binaries downloaded during installation.
