...
{
    private static readonly Lazy<ushort> _nativeArch = new(DetectNativeArch);
    ...
    /// <summary>True when the native Windows platform is ARM64.</summary>
    public static bool IsArm64 => _nativeArch.Value == NativeMethods.PROCESSOR_ARCHITECTURE_ARM64;
    ...
    /// (x86, x64, or ARM64). Itanium and unknown architectures return <c>false</c>.
    /// </summary>
    public static bool IsSupported => Arch != 0;

    private static ushort DetectNativeArch()
    {
